...
`C` `C++` `Python` `JavaScript` `HTML` `CSS` `React` `Node.js` `SQL` `Git`

### outside of code

UI/UX, Figma, trying out random ideas, and probably spending way too long deciding how something should look.
